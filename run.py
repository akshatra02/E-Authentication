...
filename = PhotoImage(file="pictures\\bg.jpg")
background_label=Label(window,image = filename)
background_label.place(x=0,y=0, relwidth=1, relheight=1)
login_label= tk.Label(window, text="USER AUTHENTICATION" ,bg="#71B280"  ,fg="#2C5364"  ,width=100 ,height=1,font=('times', 35, 'bold')).pack(fill = 'x')
...
#HEADINGS
login_label= tk.Label(window, text="Login Here" ,bg="#2C5364"  ,fg="#71B280"  ,width=20 ,height=1,font=('times', 30, 'bold')) 
login_label.place(x=40, y=150)

reg_label= tk.Label(window, text="Register Here" ,bg="#2C5364"  ,fg="#71B280"  ,width=20 ,height=1,font=('times', 30, 'bold')) 
reg_label.place(x=700, y=150)

msg_label=tk.Label(window,text="Notification: ",bg='#134E5E' ,fg='#71B280',width=10,height=1,font=('times',20,'bold'))
...
#Login FIEDLS 
lbl = tk.Label(window, text="Enter ID :",width=10,height=1  ,fg="#134E5E" ,bg="#71B280" ,font=('times', 15, ' bold ') ) 
lbl.place(x=30, y=210)

txt = tk.Entry(window,width=25  ,fg="#0F2027" ,bg="#71B280",font=('times', 15, ' bold '))
txt.place(x=300, y=210)

lbl2= tk.Label(window, text="Enter Password :",width=15  ,height=1  ,fg="#134E5E" ,bg="#71B280" ,font=('times', 15, ' bold ') ) 
lbl2.place(x=30, y=250)

txt2 = tk.Entry(window,width=25  ,bg="#71B280" ,show='*',fg="#0F2027",font=('times', 15, ' bold '))
txt2.place(x=300, y=250)

address_field1= tk.Label(window, text="E-mail Address :",width=20,height=1  ,fg="#134E5E" ,bg="#71B280" ,font=('times', 15, ' bold ') )
address_field1.place(x=30,y=290)
address = StringVar()
address_entry1=tk.Entry(window,textvariable=address,width=25  ,bg="#71B280" ,fg="#0F2027",font=('times', 15, ' bold '))
address_entry1.place(x=300,y=290)
mail=address_entry1.get()

OTP= tk.Label(window, text="OTP :",width=20,height=1  ,fg="#134E5E" ,bg="#71B280" ,font=('times', 15, ' bold ') )
OTP.place(x=30,y=385)
otp_entry=tk.Entry(window,width=25  ,bg="#71B280" ,fg="#0F2027",font=('times', 15, ' bold '))
otp_entry.place(x=300,y=385)
o=otp_entry.get()
print(o)
...
lbl3 = tk.Label(window, text="Enter ID :",width=10  ,height=1  ,fg="#134E5E"  ,bg="#71B280" ,font=('times', 15, ' bold ') ) 
lbl3.place(x=700, y=213)

txt3 = tk.Entry(window,width=25  ,bg="#71B280" ,fg="#0F2027",font=('times', 15, ' bold '))
txt3.place(x=940, y=213)

lbl4= tk.Label(window, text="Enter Password",width=15  ,height=1  ,fg="#134E5E"  ,bg="#71B280" ,font=('times', 15, ' bold ') ) 
lbl4.place(x=700, y=250)

txt4 = tk.Entry(window,width=25  ,bg="#71B280" ,show='*',fg="#0F2027",font=('times', 15, ' bold '))
txt4.place(x=940, y=250)

address_field2= tk.Label(window, text="Enter E-mail :",width=15,height=1  ,fg="#134E5E" ,bg="#71B280" ,font=('times', 15, ' bold ') )
address_field2.place(x=700,y=287)
address = StringVar()
address_entry2=tk.Entry(window,textvariable=address,width=25  ,bg="#71B280" ,fg="#0F2027",font=('times', 15, ' bold '))
address_entry2.place(x=940,y=287)
...
def on_enter(button):
    button.config(bg="#134E5E", fg="#71B280")

def on_leave(button):
    button.config(bg="#71B280", fg="#134E5E")


#Login Actions
otpsubmit = tk.Button(window, text="Send OTP",fg="#134E5E",command= sendMail, bg="#71B280"  ,width=20  ,height=1 ,activebackground = "#203A43" ,font=('times', 14, ' bold '))
otpsubmit.place(x=325, y=330)

submit = tk.Button(window, text="Submit",fg="#134E5E",command= login_submit, bg="#71B280"  ,width=20  ,height=1 ,activebackground = "#203A43" ,font=('times', 14, ' bold '))
submit.place(x=30, y=425)

clearButton = tk.Button(window, text="Clear", command=login_clear,fg="#134E5E" ,bg="#71B280"  ,width=20  ,height=1, activebackground = "#203A43" ,font=('times', 14, ' bold '))
clearButton.place(x=325, y=425)

#Register Actions
submit2 = tk.Button(window, text="Submit", command=reg_submit ,fg="#134E5E" ,bg="#71B280", width=20  ,height=1 ,activebackground = "#203A43" ,font=('times', 14, ' bold '))
submit2.place(x=700, y=340)


clearButton2 = tk.Button(window, text="Clear",command=reg_clear ,fg="#134E5E" ,bg="#71B280" ,width=20  ,height=1, activebackground = "#203A43" ,font=('times', 14, ' bold '))
clearButton2.place(x=940, y=340)

quitWindow = tk.Button(window, text="Quit", command=window.destroy  ,fg="#134E5E" ,bg="#71B280"  ,width=20  ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
quitWindow.place(x=1000, y=550)


but=[clearButton2,submit2,clearButton,submit,quitWindow,otpsubmit]
for button in but:
